    ...
    <div>
        ...
        <div className="container mt-3 pt-3">
					<div className="row">
						<div className="col-12">
							<div className="card border-dark text-bg-dark">
								<img  src={require("../../assets/images/Sweet-Nostalgia.png")} alt="Sweet-Nostalgia" className="card-img-top"/>
                ...
                <ul className="list-group list-group-flush">
									<li className="list-group-item bg-dark text-white">Handlebars, MVC-architecture, MySQL...</li>
									<li className="list-group-item bg-dark text-white">Full-Stack</li>
									<li className="list-group-item bg-dark text-white"><a href="https://github.com/Brainybrian316/Sweet-Nostalgia" target="_blank" rel="noopener noreferrer">GitHub</a></li>
								</ul>
								<div className="p-3">
									<a className="btn btn-primary float-end" href="https://sweet-nostalgia.herokuapp.com/" target="_blank" rel="noopener noreferrer" role="button">Visit Site</a>
                </div>
                </div>
                </div>
                </div>
